...
const dataExportController = __importStar(require("../controllers/dataExportController"));
...
router.post('/validate', upload.single('file'), dataExportController.validateImportFile);
